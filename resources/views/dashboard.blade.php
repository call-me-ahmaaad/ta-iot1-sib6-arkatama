            ...
            $(document).ready(function() {
                ...
                var chart = Highcharts.chart('container-gauge', Highcharts.merge(gaugeOptions, {
                    ...
                    series: [{
                        ...
                        data: [0],
                        dataLabels: {
                            format: '<div style="text-align:center"><span style="font-size:25px">{y}</span><br/><span style="font-size:12px;opacity:0.4;font-family:'JetBrains Mono', monospace">ppm</span></div>'
                        },
                        tooltip: {
                            valueSuffix: ' ppm'
                        }
